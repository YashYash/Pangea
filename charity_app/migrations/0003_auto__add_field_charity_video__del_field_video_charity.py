...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'charity_app_charity', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['charity_app.Video']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Video.charity'
        raise RuntimeError("Cannot reverse this migration. 'Video.charity' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Video.charity'
        db.add_column(u'charity_app_video', 'charity',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['charity_app.Charity']),
                      keep_default=False)
